...
# -*- coding: utf-8 -*-
"""
Plot the result of experiments for figure 4B-D
"""
import pandas as pd 
import pickle
import numpy as np
...
plt.hist(H_Each_mean_im, color='r', bins=20, hatch='/', alpha=0.5)
plt.hist(H_Each_mean_phys, color='b', bins=20, hatch='\\', alpha=0.5)
...
plt.figure(figsize=(10, 10))
# Plotting histograms with striped patterns
plt.hist(V_Each_mean_im, color='r', bins=20, hatch='/', alpha=0.5)
plt.hist(V_Each_mean_phys, color='b', bins=20, hatch='\\', alpha=0.5)
